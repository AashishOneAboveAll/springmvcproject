      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
             <li class="active"><a href="${pageContext.request.contextPath}/upload">Upload<span class="sr-only">(current)</span></a></li>
	...
	<table id="myTable" class="table table-stripted">
		...
		<tbody>
			<c:forEach var="student" items="${slist}">
				...
				<td><input type="button" onclick="editStudent(${student.id})" class="btn btn-success" value="Edit">
				<td><input type="button"  class="btn btn-danger" value="Delete" onclick="deleteStudent(${student.id})">
					</td>
				</tr>
